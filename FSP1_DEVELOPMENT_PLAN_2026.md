...
### For Deep-Science KOLs / Academic Audiences

**Biology novelty claims:**

> *"We are the first program deliberately optimized for KEAP1/STK11/NFE2L2-altered LUAD, using FSP1-high IHC plus ferroptosis PD as mandatory entry criteria and on-treatment biopsy endpoints."*

> *"We systematically integrate FSP1 inhibition with DGAT1 and SLC7A11 biology into a triple ferroptosis concept, pre-defining combination partners and biomarkers from day one."*

**Key differentiators:**
| Element | Novelty vs Current Field |
|---------|------------------------|
| Patient selection | FSP1 IHC + KEAP1/STK11/NFE2L2 genomic + CoQ redox PD (triple biomarker) |
| Triple ferroptosis | DGAT1i + SLC7A11i + FSP1i platform (not single-axis) |
| Translational assays | ^13C-glucose/acetate flux + oxidized phospholipid lipidomics embedded in core cascade |
| Clinical PD | Mandatory on-treatment biopsy for ferroptosis engagement (CoQ redox, 4-HNE IHC) |

---

### For Domain-Expert Investors / Biotech VCs

**Investment thesis (1 paragraph):**

> FSP1 is a clinically validated but undrugged target in NSCLC. The biology (KEAP1/NRF2/FSP1 axis, ferroptosis resistance) is published in Nature-level journals; the chemistry (FSEN1 co-crystal, viFSP1, multiple chemotypes) is public; but no FSP1 inhibitor has entered clinical trials. We are the first to: (1) narrow to KEAP1/STK11/NFE2L2-altered LUAD with concordant biomarkers (IHC + NGS + ferroptosis PD), (2) build a triple-ferroptosis platform (DGAT1 + SLC7A11 + FSP1), and (3) execute a Project Optimus-aligned clinical path with mandatory ferroptosis engagement endpoints. This is not a "me-too" FSP1 program — it is a biomarker-defined, combination-ready, first-in-class opportunity in a $40B+ market with no metabolic drug approved.

**Key metrics:**
| Metric | Value |
|--------|-------|
| Target IC50 | <50 nM (vs 60 nM FSEN1) |
| Selectivity | ≥30-fold over redox enzymes |
| Therapeutic window | TGI >50% without >10% BWL |
| Timeline to IND | 30-42 months |
| Cost to IND | $15-35M |
| Market size | $40B+ NSCLC |
| First-in-class | No FSP1 inhibitor in clinic |

---

### For Generalist VCs / Strategic Pharma BD

**One-slide pitch:**

| Slide Element | Content |
|---------------|---------|
| **Problem** | No metabolism-directed drug approved for NSCLC; KEAP1/STK11-altered patients have poor outcomes and PD-1 resistance |
| **Solution** | First-in-class FSP1 inhibitor, biomarker-selected (FSP1 IHC + KEAP1/STK11 genotype) |
| **Science** | KEAP1 mutation → NRF2 → FSP1 ↑ → ferroptosis protection; FSP1 inhibition = selective tumor ferroptosis |
| **Data** | Nature 2025: 80% tumor reduction in mice; PNAS 2025: FSEN1 co-crystal |
| **Pipeline** | FSP1 (NSCLC) + ACLY/ACSS2 (MASH) + Triple ferroptosis platform |
| **Team/Assets** | ARP pipeline with 8 playbooks, novel chemistry, biomarker strategy |
| **Milestone** | Lead optimization 2026-2027, IND 2028 |
| **Exit** | Partnership at IND ($100-200M) or Phase II ($500M-1B) |

**Competitive moat:**
1. First mover in KEAP1/STK11/NFE2L2-focused FSP1 inhibitor
2. Triple ferroptosis platform (not single-target)
3. Biomarker-defined indication (companion diagnostic)
4. Novel chemistry with Freedom to Operate

---

### What Is Already "Crowded" (Do Not Claim)

| Do NOT Claim | Reason |
|-------------|--------|
| FSP1 as a cancer target | Already published (Nature 2025) |
| KEAP1/NRF2/FSP1 axis | Already established |
| FSEN1/viFSP1/iFSP1 chemotypes | Already public |
| Ferroptosis as cancer mechanism | Widely accepted |

### What Is Truly Novel (Do Claim)

| Claim | Novelty Level |
|-------|--------------|
| Concordant biomarker panel (FSP1 IHC + genotype + ferroptosis PD) | **High** — not yet proposed in literature |
| Triple ferroptosis platform (DGAT1 + SLC7A11 + FSP1) | **High** — novel portfolio approach |
| Project Optimus-aligned dose selection | **High** — no FSP1 trial has done this |
| On-treatment biopsy for ferroptosis engagement | **High** — most trials only measure target occupancy |
| Parallel FSEN1/viFSP1 development with explicit developability criteria | **Medium** — chemotypes public, but integration and ranking is novel |
| Triple-tier combination strategy (RT, ICI,chemo) with biomarker enrichment | **Medium** — combinations mentioned but not structured this way |
...
|----------|-----------------|------------------|
| **Deep-science KOLs** | Triple ferroptosis platform + mandatory ferroptosis PD | Biomarker cascade (IHC → genomics → on-treatment biopsy) |
| **Expert investors** | First-in-class in $40B market, 30-month path to IND, biomarker-defined | Triple combo reduces risk, platform potential |
| **Generalist VCs/Pharma BD** | FSP1 is validated but undrugged; our edge is patient selection + combination roadmap | Fast to IND, clear exit via partnership |

---

*Novelty statement refined: 2026-05-10 | ARP v24*
*Target audiences: KOLs, expert investors, generalist VCs, pharma BD*